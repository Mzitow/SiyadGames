...
public class PuzzleLayout extends RelativeLayout {
   ...
   // static  int scrolls = move;

    /**
     * One-to-one correspondence between the sub-View index and the index of models in mHelper,
     * The model synchronizes to update the currentPosition every time the position of the child View is exchanged.
     */
